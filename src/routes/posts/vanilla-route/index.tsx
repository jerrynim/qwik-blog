    ...
    return (
        <>
            ...
            <PostHead>
                ...
                <PostTag tags="Vanilla Javascript SPA 라우팅"></PostTag>
            ...
            <PostBody>
                ...
                <PostLink href="https://developer.mozilla.org/en-US/docs/Web/API/Window/history">
                    window.history
                </PostLink>
                의 pushState 메서드를 사용하여 주소 변경을 할 수 있습니다.
                <br />
                pushState 메서드는 (데이터, 타이틀, URL)의 매개변수를 받도록
                되어있습니다.
                ...
                콘텐츠를 바꾸는것이 라우팅의 원리가 되겠습니다.
                <br />
                주소가 변경된 것을 알리고 감지하기 위하여
                <code>locationchange</code>라는
                <PostLink href="https://developer.mozilla.org/en-US/docs/Web/API/CustomEvent/CustomEvent">
                    커스텀 이벤트
                </PostLink>
                를 만들도록 하겠습니다.
                <PostCode
                ...
                콘텐츠가 바뀌지 않는 것을 볼 수 있습니다.
                <br />
                이를 위해 뒤로 가기 및 앞으로가기 이벤트를 감지하는
                <PostLink href="https://developer.mozilla.org/ko/docs/Web/API/Window/popstate_event">
                    popstate
                </PostLink>
                ...
                <br />
                앞에서 다룬 내용을
                <PostLink href="https://github.com/jerrynim/vanillajs-router/tree/master">
                    깃허브
                </PostLink>
                에 예제를 통해 올리도록 하겠습니다.
                <br />
                ...
                <br />
                *이 블로그에서 사용한
                <PostLink href="https://github.com/jerrynim/lit-blog/blob/master/components/root-router.ts">
                    lit-html을 사용한 라우터
                </PostLink>
                도 첨부하도록 하겠습니다.
            </PostBody>
