...
export const head: DocumentHead = {
  title: "proxy 사용시 edge runtime을 사용하는 이유와 제약",
  meta: [
    {
      property: "keywords",
      content: "nextjs edge runtime proxy",
    },
    {
      property: "description",
      content: "proxy 사용시 edge runtime을 사용하는 이유와 제약",
    },
  ],
};
...
export default component$(() => {
  return (
    <>
      ...
      <PostHead>
        <h1>proxy 사용시 edge runtime을 사용하는 이유와 제약</h1>
      ...
      <PostBody>
        ...
        <br />
        Edge runtime을 사용함으로서 다음과 같음 이점을 가질수 있습니다.
        <ul>
          <li>Web Standard API 기반의 경량화된 런타임</li>
          <li>빠른 cord start(Edge worker의 V8 isolate 사용시)</li>
        ...
        <br />
        Porxy는 Node.js의 vm 모듈을 사용하여 격리된 JavaScript 실행 환경을
        만듭니다.
        <PostCode
          code={code}
          language="typescript"
        ...
        />
        <br />
        따라서 단일 Node.js 프로세스환경에서 Node.js 힙을 공유하게되며 Edge
        Runtime의 이점을 가지지 못합니다.
        <br />
        하지만 Next.js 는 동일한 환경을 제공하기위해 제한된 Node.js API제공등의
        작업을 수행합니다.
        <br />
        process.env 를 사용할 수 있게 합니다.
        ...
        <br />
        ISR을 사용할 수 없는이유도 동일합니다. ISR은 파일 시스템 캐싱을
        사용하여야하지만 Edge Runtime에서는 fs 모듈 사용이 불가합니다.
        <br />
        <br />
        참조 링크 :
